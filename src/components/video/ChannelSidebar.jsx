...
export const ChannelSidebar = ({
    ...
    return (
        <div className="w-full lg:w-80 bg-gray-900/30 border-t border-gray-800 lg:border-t-0 lg:border-l flex flex-col shrink-0 lg:h-[calc(100vh-64px)] overflow-hidden z-10 min-h-0">
