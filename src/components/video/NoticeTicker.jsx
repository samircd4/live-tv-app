...
export const NoticeTicker = () => {
    ...
    const notices = [
        "🔥 সারকার শপে স্বাগতম — বাংলাদেশের অন্যতম বিশ্বস্ত স্মার্টফোন, গ্যাজেট ও অ্যাকসেসরিজের অনলাইন মার্কেটপ্লেস।",
    ...
    return (
        <div
            className="absolute inset-x-0 bottom-18 z-40 h-20 flex items-center overflow-hidden select-none border-y border-yellow-500/20 bg-black/85 backdrop-blur-xl shadow-[0_0_40px_rgba(255,193,7,0.15)]"
            onMouseEnter={(e) => {
                e.stopPropagation();
                setPaused(true);
            }}
        ...
        >
            ...
            <div className="relative flex-1 h-full overflow-hidden bg-gradient-to-r from-gray-950/80 via-black/60 to-gray-950/80 flex items-center">
                ...
                >
                    <span className="text-yellow-400 font-extrabold text-2xl pr-4">
                        {combinedText}
                    </span>
                    <span className="text-yellow-400 font-extrabold text-2xl pr-4">
                        {combinedText}
            ...
            <div className="h-full shrink-0 flex flex-col items-center justify-center px-6 bg-gradient-to-l from-yellow-500 via-amber-400 to-yellow-500 text-black">
                <div className="text-center font-black text-2xl">
                    {formatDate(currentTime)}
                </div>

                <div className="mt-1 font-mono text-2xl font-black tracking-[0.15em] bg-black text-yellow-400 px-4 py-1 rounded-lg">
